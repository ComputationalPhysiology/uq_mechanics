...
class CovarianceMatrix:
    ...
    def build_preconditioner(self, k=100):
        ...
        if self.verbose:
            print
            "Tree building time = %g" % (end - start)
        ...
        if self.verbose:
            print
            "Nearest neighbor computation time = %g" % (end - start)
        ...
        "Building preconditioner took  = %g" % (end - start)
    ...
    def solve(self, b, maxiter=1000, tol=1.e-10):
        ...
        if self.method == 'Dense':
            ...
            if self.verbose:
                print
                "Number of iterations is %g and status is %g" % (residual.itercount(), info)
        return x
