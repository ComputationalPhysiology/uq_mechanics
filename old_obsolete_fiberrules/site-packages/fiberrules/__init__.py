"""Expose names from the compiled cpp modules to the fiberrules.cpp namespace"""
...
import dolfinfiberrules
from dolfinfiberrules import *
__all__.extend(dolfinfiberrules.__all__)
...
# Add version 
# -----------
globals()["__version__"] = getattr(cpp, "__fiberrulesversion__")
